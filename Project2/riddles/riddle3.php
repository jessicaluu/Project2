    ...
    <div class="riddle">
      <div class="question">
        <form action="#" method="post">
          <p><h3>What is the best month for a parade?</h3>
          <input type="text" name="riddle3"><br><br>
          <input type="submit" name="submit" value="CHECK ANSWER"><br>
        </form>

        <?php
        if (isset($_POST['riddle3'])) {
          if ($_POST['riddle3'] == "March" || $_POST['riddle3'] == "MARCH" || $_POST['riddle3'] == "march") {
