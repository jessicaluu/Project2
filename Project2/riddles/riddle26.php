    ...
    <div class="riddle">
      <div class="question">
        <form action="#" method="post">
          <p><h3>What surrounds the world, yet dwells within a thimble?</h3>
          <input type="text" name="riddle26"><br><br>
          <input type="submit" name="submit" value="CHECK ANSWER"><br>
        </form>

        <?php
        if (isset($_POST['riddle26'])) {
          if ($_POST['riddle26'] == "Space" || $_POST['riddle26'] == "SPACE" || $_POST['riddle26'] == "space") {
