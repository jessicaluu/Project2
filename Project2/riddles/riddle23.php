    ...
    <div class="riddle">
      <div class="question">
        <form action="#" method="post">
          <p><h3>What goes up when rain comes down?</h3>
          <input type="text" name="riddle23"><br><br>
          <input type="submit" name="submit" value="CHECK ANSWER"><br>
        </form>

        <?php
        if (isset($_POST['riddle23'])) {
          if ($_POST['riddle23'] == "Umbrella" || $_POST['riddle23'] == "UMBRELLA" || $_POST['riddle23'] == "umbrella") {
