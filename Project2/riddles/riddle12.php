    ...
    <div class="riddle">
      <div class="question">
        <form action="#" method="post">
          <p><h3>What two things can always see what the other sees, but can never see each other?</h3>
          <input type="text" name="riddle12"><br><br>
          <input type="submit" name="submit" value="CHECK ANSWER"><br>
        </form>

        <?php
        if (isset($_POST['riddle12'])) {
          if ($_POST['riddle12'] == "Eyes" || $_POST['riddle12'] == "EYES" || $_POST['riddle12'] == "eyes") {
